...
const themeSharedFields = {
	...
	spacing: t.Optional(
		t.Object({
			buttonPaddingX: t.Number({ minimum: 0, maximum: 64 }),
			badgePaddingX: t.Number({ minimum: 0, maximum: 64 }),
			badgePaddingY: t.Number({ minimum: 0, maximum: 64 }),
			cardPadding: t.Number({ minimum: 0, maximum: 96 }),
			panelPadding: t.Number({ minimum: 0, maximum: 64 }),
			fieldPaddingX: t.Number({ minimum: 0, maximum: 64 }),
			menuItemPaddingX: t.Number({ minimum: 0, maximum: 32 }),
			buttonHeight: t.Number({ minimum: 16, maximum: 96 }),
			buttonHeightSm: t.Number({ minimum: 16, maximum: 96 }),
			buttonHeightLg: t.Number({ minimum: 16, maximum: 96 }),
			fieldHeight: t.Number({ minimum: 16, maximum: 96 }),
			menuItemHeight: t.Number({ minimum: 16, maximum: 96 }),
			switchTrackWidth: t.Number({ minimum: 16, maximum: 96 }),
			switchThumbSize: t.Number({ minimum: 6, maximum: 48 }),
			iconButtonSize: t.Number({ minimum: 16, maximum: 96 }),
