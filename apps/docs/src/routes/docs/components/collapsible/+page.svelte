<script lang="ts">
	...
	const apiRows = [
		...
		},
		{
			...
			type: '--',
			default: '--',
			description: 'Revealed region when open.'
		}
	];
	...
	const heroCode = `<Collapsible.Root bind:open>
...
<div data-docs-page class="flex flex-col gap-10">
	...
	<header class="flex flex-col gap-4">
		<div>
			...
			>
				A single expandable panel. Simpler than Accordion when you need just one item. Animates
				height and reveals content on demand.
			</p>
		</div>
	</header>
		...
		<ComponentPreview code={heroCode}>
			<div class="w-full max-w-md">
				<Collapsible.Root bind:open>
					...
					<Collapsible.Content>
						Yes — the trigger is a real button with `aria-expanded` and the content has
						`role="region"`.
					</Collapsible.Content>
				</Collapsible.Root>
			</div>
	...
	<section id="installation" class="scroll-mt-20 flex flex-col gap-4">
		...
		<p class="text-sm text-foreground-muted">Install the Collapsible component with the CLI:</p>
		<Steps
			steps={[
				{
					title: 'Run the CLI',
	...
	<section id="usage" class="scroll-mt-20 flex flex-col gap-4">
		...
		<p class="text-sm text-foreground-muted">Import the Collapsible components and use them:</p>
		<pre
	...
	<section id="examples" class="scroll-mt-20 flex flex-col gap-10">
		...
		<div id="starts-open" class="scroll-mt-20 flex flex-col gap-3">
			...
			<ComponentPreview
				code={`<Collapsible.Root open>
  <Collapsible.Trigger>Close panel</Collapsible.Trigger>
  <Collapsible.Content>This panel starts open.</Collapsible.Content>
</Collapsible.Root>`}
			>
				<div class="w-full max-w-md">
	...
	<section id="api" class="scroll-mt-20 flex flex-col gap-4">
		...
		<p class="text-sm text-foreground-muted">
			<code class="font-mono text-foreground">Collapsible</code> exports
	...
	>
		<div class="flex flex-col gap-1">
			...
			<p class="m-0 text-[0.86rem] text-foreground-muted">
				Every Collapsible token lives in the studio — restyle it for your brand in seconds.
			</p>
		</div>
