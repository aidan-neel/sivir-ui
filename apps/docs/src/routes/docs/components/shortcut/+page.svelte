<script lang="ts">
	...
	const heroCode = '<Shortcut shortcut="K" />';
</script>
...
<div data-docs-page class="flex flex-col gap-10">
	...
	<header class="flex flex-col gap-4">
		<div>
			...
			>
				A small badge for displaying keyboard shortcuts inline. Perfect for command palettes, help
				menus, and shortcuts documentation.
			</p>
		</div>
	</header>
	...
	<section id="installation" class="scroll-mt-20 flex flex-col gap-4">
		...
		<p class="text-sm text-foreground-muted">Install the Shortcut component with the CLI:</p>
		<Steps
			steps={[
				{
					title: 'Run the CLI',
	...
	<section id="examples" class="scroll-mt-20 flex flex-col gap-10">
		...
		<div id="basic" class="scroll-mt-20 flex flex-col gap-3">
			...
			<ComponentPreview code="<Shortcut shortcut=&quot;K&quot; />">
				<Shortcut shortcut="K" />
			</ComponentPreview>
		</div>
		...
		<div id="modifiers" class="scroll-mt-20 flex flex-col gap-3">
			...
			<ComponentPreview
				code="<div class=&quot;flex gap-2&quot;><Shortcut shortcut=&quot;cmd+K&quot; /><Shortcut shortcut=&quot;shift+/&quot; /></div>"
			>
		...
		<div id="context" class="scroll-mt-20 flex flex-col gap-3">
			...
			<ComponentPreview
				code="<div class=&quot;flex items-center justify-between w-full max-w-xs px-3 py-2 rounded border border-border&quot;><span class=&quot;text-sm&quot;>Open command menu</span><Shortcut shortcut=&quot;cmd+K&quot; /></div>"
			>
				<div
					class="flex items-center justify-between w-full max-w-xs px-3 py-2 rounded border border-border"
				>
					<span class="text-sm">Open command menu</span>
					<Shortcut shortcut="cmd+K" />
				</div>
			</ComponentPreview>
		</div>
	...
	<section id="api" class="scroll-mt-20 flex flex-col gap-4">
		...
		<p class="text-sm text-foreground-muted">
			<code class="font-mono text-foreground">Shortcut</code> is the only export.
		</p>
