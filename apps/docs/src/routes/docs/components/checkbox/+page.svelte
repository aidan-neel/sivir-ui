...
<div data-docs-page class="flex flex-col gap-10">
	...
	<header class="flex flex-col gap-4">
		<div>
			...
			>
				A standard checkbox with built-in label and description. Keyboard-accessible, bindable, and
				readily disabled.
			</p>
		</div>
	</header>
	...
	<section id="api" class="scroll-mt-20 flex flex-col gap-4">
		...
		<p class="text-sm text-foreground-muted">
			<code class="font-mono text-foreground">Checkbox</code> is the only export.
		</p>
	...
	>
		<div class="flex flex-col gap-1">
			...
			<p class="m-0 text-[0.86rem] text-foreground-muted">
				Every Checkbox token lives in the studio — restyle it for your brand in seconds.
			</p>
		</div>
