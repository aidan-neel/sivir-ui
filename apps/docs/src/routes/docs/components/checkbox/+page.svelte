...
<div class="flex flex-col gap-16 pt-16">
	...
	<section class="scroll-mt-20 flex flex-col gap-5">
		...
		<div class="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4">
			{#each [{ label: 'Unchecked', value: false }, { label: 'Checked', value: true }, { label: 'Disabled', value: false, disabled: true }, { label: 'Disabled + on', value: true, disabled: true }] as state (state.label)}
				<div
