<script lang="ts">
	...
	const SOURCE = 'https://github.com/aidan-neel/silk/tree/main/registry/silk/default/pagination';
	...
	const installCommand = 'bunx @aidan-neel/ui add pagination';
	const heroCode = '<Pagination bind:page total={20} />';
</script>

<svelte:head>
	<title>Silk · Pagination</title>
	<meta
		name="description"
...
<div data-docs-page class="flex flex-col gap-10">
	...
	<header class="flex flex-col gap-4">
		<div>
			...
			>
				A compact pager that truncates with an ellipsis. Always shows the first and last page so
				users know how big the data set is.
			</p>
		</div>
	</header>
	...
	<section id="installation" class="scroll-mt-20 flex flex-col gap-4">
		...
		<p class="text-sm text-foreground-muted">Install the Pagination component with the CLI:</p>
		<Steps
			steps={[
				{
					title: 'Run the CLI',
	...
	<section id="usage" class="scroll-mt-20 flex flex-col gap-4">
		...
		<p class="text-sm text-foreground-muted">Import the Pagination component and use it:</p>
		<pre
	...
	<section id="api" class="scroll-mt-20 flex flex-col gap-4">
		...
		<p class="text-sm text-foreground-muted">
			<code class="font-mono text-foreground">Pagination</code> accepts the following props.
		</p>
