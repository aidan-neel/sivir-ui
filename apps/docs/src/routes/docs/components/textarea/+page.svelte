<script lang="ts">
	...
	const heroCode = '<Textarea bind:value label="Message" />';
</script>
...
<div data-docs-page class="flex flex-col gap-10">
	...
	<header class="flex flex-col gap-4">
		<div>
			...
			>
				A multi-line text input that shares Input's styling and grammar. Use it for longer text like
				messages, bios, or feedback.
			</p>
		</div>
	</header>
	...
	<section id="installation" class="scroll-mt-20 flex flex-col gap-4">
		...
		<p class="text-sm text-foreground-muted">Install the Textarea component with the CLI:</p>
		<Steps
			steps={[
				{
					title: 'Run the CLI',
	...
	<section id="examples" class="scroll-mt-20 flex flex-col gap-10">
		...
		<div id="labeled" class="scroll-mt-20 flex flex-col gap-3">
			...
			<ComponentPreview
				code="<Textarea label=&quot;Feedback&quot; description=&quot;Tell us what you think.&quot; />"
			>
				<div class="w-full max-w-sm">
					<Textarea label="Feedback" description="Tell us what you think." />
				</div>
			</ComponentPreview>
		</div>
		...
		<div id="disabled" class="scroll-mt-20 flex flex-col gap-3">
			...
			<ComponentPreview
				code="<Textarea disabled value=&quot;Cannot edit this text&quot; label=&quot;Disabled&quot; />"
			>
				<div class="w-full max-w-sm">
	...
	<section id="api" class="scroll-mt-20 flex flex-col gap-4">
		...
		<p class="text-sm text-foreground-muted">
			<code class="font-mono text-foreground">Textarea</code> is the only export.
		</p>
