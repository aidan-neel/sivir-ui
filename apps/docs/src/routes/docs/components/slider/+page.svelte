...
<div data-docs-page class="flex flex-col gap-10">
	...
	<header class="flex flex-col gap-4">
		<div>
			...
			>
				A themed wrapper around the native range input. Keyboard-driven for free, drag-to-set on
				every device.
			</p>
		</div>
	</header>
	...
	<section id="examples" class="scroll-mt-20 flex flex-col gap-10">
		<div>
			...
			<p class="mt-2 text-sm text-foreground-muted">Slider with different configurations.</p>
		</div>
	...
	<section id="api" class="scroll-mt-20 flex flex-col gap-4">
		...
		<p class="text-sm text-foreground-muted">
			<code class="font-mono text-foreground">Slider</code> is the only export.
		</p>
