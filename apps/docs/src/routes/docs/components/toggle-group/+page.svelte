...
<div data-docs-page class="flex flex-col gap-10">
	...
	<header class="flex flex-col gap-4">
		<div>
			...
			>
				A row of toggles with shared selection state. Use single for radio-like behavior, multiple
				for checkbox-like groups.
			</p>
		</div>
	</header>
	...
	<section id="examples" class="scroll-mt-20 flex flex-col gap-10">
		<div>
			...
			<p class="mt-2 text-sm text-foreground-muted">Toggle Group in single and multiple modes.</p>
		</div>
	...
	<section id="api" class="scroll-mt-20 flex flex-col gap-4">
		...
		<p class="text-sm text-foreground-muted">
			Compose Toggle Group with Root and Item sub-components.
		</p>
