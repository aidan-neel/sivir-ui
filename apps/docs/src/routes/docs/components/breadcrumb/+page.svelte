<script lang="ts">
	...
	const heroCode = `<Breadcrumb.Root>
...
<div data-docs-page class="flex flex-col gap-10">
	...
	<section id="installation" class="scroll-mt-20 flex flex-col gap-4">
		...
		<p class="text-sm text-foreground-muted">Install the Breadcrumb component with the CLI:</p>
		<Steps
			steps={[
				{
					title: 'Run the CLI',
	...
	<section id="usage" class="scroll-mt-20 flex flex-col gap-4">
		...
		<p class="text-sm text-foreground-muted">Import and use the Breadcrumb components:</p>
		<pre
	...
	<section id="api" class="scroll-mt-20 flex flex-col gap-4">
		...
		<p class="text-sm text-foreground-muted">
			<code class="font-mono text-foreground">Breadcrumb</code> exports
			<code class="font-mono text-foreground">Root</code>,
			<code class="font-mono text-foreground">Item</code>, and
			<code class="font-mono text-foreground">Separator</code>.
		</p>
	...
	>
		<div class="flex flex-col gap-1">
			...
			<p class="m-0 text-[0.86rem] text-foreground-muted">
				Every Breadcrumb token lives in the studio — restyle it for your brand in seconds.
			</p>
		</div>
