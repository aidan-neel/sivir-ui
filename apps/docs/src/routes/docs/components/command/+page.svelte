...
<div data-docs-page class="flex flex-col gap-10">
	...
	<header class="flex flex-col gap-4">
		<div>
			...
			>
				A fast command palette modal with fuzzy search, grouped results, and keyboard shortcuts.
				Commonly triggered by Cmd+K or Ctrl+K.
			</p>
		</div>
	</header>
	...
	<section id="api" class="scroll-mt-20 flex flex-col gap-4">
		...
		<p class="text-sm text-foreground-muted">
			<code class="font-mono text-foreground">Command</code> exports
			...
			<code class="font-mono text-foreground">Search</code>,
			<code class="font-mono text-foreground">Results</code>,
			<code class="font-mono text-foreground">Group</code>, and
	...
	>
		<div class="flex flex-col gap-1">
			...
			<p class="m-0 text-[0.86rem] text-foreground-muted">
				Every Command token lives in the studio — restyle it for your brand in seconds.
			</p>
		</div>
