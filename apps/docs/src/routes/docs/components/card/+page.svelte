...
<div data-docs-page class="flex flex-col gap-10">
	...
	<section id="installation" class="scroll-mt-20 flex flex-col gap-4">
		...
		<p class="text-sm text-foreground-muted">Install the Card component with the CLI:</p>
		<Steps
			steps={[
				{
					title: 'Run the CLI',
	...
	<section id="usage" class="scroll-mt-20 flex flex-col gap-4">
		...
		<p class="text-sm text-foreground-muted">Import Card and compose it with sub-components:</p>
		<pre
	...
	<section id="examples" class="scroll-mt-20 flex flex-col gap-10">
		...
		<div id="content-only" class="scroll-mt-20 flex flex-col gap-3">
			...
			<ComponentPreview code="<Card.Root><Card.Content>Content here</Card.Content></Card.Root>">
				<Card.Root class="w-full max-w-[28rem]">
					<Card.Content>
		...
		<div id="header-footer" class="scroll-mt-20 flex flex-col gap-3">
			...
			<ComponentPreview
				code="<Card.Root><Card.Header><Card.Title>Title</Card.Title></Card.Header><Card.Footer><Button>Action</Button></Card.Footer></Card.Root>"
			>
				<Card.Root class="w-full max-w-[28rem]">
					<Card.Header>
	...
	<section id="api" class="scroll-mt-20 flex flex-col gap-4">
		...
		<p class="text-sm text-foreground-muted">
			Compose Card with Root, Header, Title, Description, Content, and Footer sub-components.
		</p>
				...
				{#each apiRows as row, i (i)}
					<li class="grid grid-cols-[1fr_1.8fr_0.5fr] gap-3 px-4 py-3 max-md:grid-cols-1">
						<div class="flex items-center gap-2">
							<button
								type="button"
								onclick={() => copy(`Card.${row.component}`, `prop-${row.component}`)}
