<script lang="ts">
	...
	const TITLE = 'Label';
	const SOURCE = 'https://github.com/aidan-neel/silk/tree/main/registry/silk/default/label';
...
<div data-docs-page class="flex flex-col gap-10">
	...
	<header class="flex flex-col gap-4">
		<div>
			...
			>
				A theme-aware form label that pairs with any input, fades correctly when the field is
				disabled via <code class="font-mono text-[0.82rem]">peer-disabled</code>.
			</p>
		</div>
	</header>
	...
	<section id="api" class="scroll-mt-20 flex flex-col gap-4">
		...
		<p class="text-sm text-foreground-muted">
			<code class="font-mono text-foreground">Label</code> is the only export. It accepts standard HTML
			label attributes.
		</p>
	...
	>
		<div class="flex flex-col gap-1">
			...
			<p class="m-0 text-[0.86rem] text-foreground-muted">
				Every Label token lives in the studio — restyle it for your brand in seconds.
			</p>
		</div>
