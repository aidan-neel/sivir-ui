...
<button
	...
	class={cn(
		'flex w-full items-center justify-between gap-3 py-4 text-left text-[0.95rem] [font-weight:var(--font-weight-button,500)] text-foreground transition-colors hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-ring)] disabled:cursor-not-allowed disabled:opacity-50',
		className
	)}
	{...rest}
>
