...
<button
	...
	class={cn(
		className,
		'rounded-[var(--radius-sm)] border border-transparent px-2.5 py-1 text-sm font-medium transition-[background-color,border-color,color,box-shadow] focus-visible:outline-none focus-visible:ring-0 focus-visible:shadow-[0_0_0_3px_var(--color-ring)] disabled:cursor-not-allowed disabled:opacity-50',
		active
