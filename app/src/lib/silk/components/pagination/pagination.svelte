	...
	{#each pages as p, i (i)}
		...
		{:else}
			<button
				...
				onclick={() => go(p)}
				class={cn(
					'inline-flex size-8 items-center justify-center rounded-[var(--radius-md)] text-[0.82rem] [font-weight:var(--font-weight-button,500)] transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-ring)]',
					p === page
