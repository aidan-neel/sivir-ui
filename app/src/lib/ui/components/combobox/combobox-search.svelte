...
<div class="flex items-center border-b gap-2 p-2 px-3 w-full">
    ...
    }} bind:value={uiState.searchContent} placeholder={placeholder} oninput={handleInput} bind:this={element} class="w-full placeholder:text-foreground-muted focus-visible:outline-none font-medium text-sm" />
</div>
