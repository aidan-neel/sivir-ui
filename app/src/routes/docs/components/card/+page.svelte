	...
	<section class="scroll-mt-20 flex flex-col gap-5">
		<div class="flex flex-col gap-1">
			<div class="flex items-center gap-2">
				...
				<h2 class="m-0 text-[1.4rem] [font-weight:var(--font-weight-label,500)] tracking-tight" style="font-family: var(--font-header);">Compositions</h2>
			</div>
					...
					<div class="grid place-items-center rounded-[var(--radius-lg)] border border-border bg-card p-6">
						<Card.Root class="w-full">
							<Card.Content class="flex flex-col items-center gap-2 py-10 text-center">
								...
								<p class="m-0 text-[0.94rem] [font-weight:var(--font-weight-label,500)]">No projects yet</p>
