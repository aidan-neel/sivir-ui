...
<header class="flex flex-col gap-5 border-b border-border/60 pb-10">
	...
	<div class="flex flex-col gap-3">
		<h1 class="m-0 text-[2.6rem] [font-weight:var(--font-weight-label,500)] [letter-spacing:var(--tracking-label,0em)] leading-[1] tracking-[-0.035em] md:text-[3rem]" style="font-family: var(--font-header);">Dialog</h1>
...
<section class="pt-12 flex flex-col gap-5">
	...
	<div class="grid grid-cols-1 gap-3 sm:grid-cols-2">
		...
		<div class="flex flex-col gap-3 rounded-[var(--radius-lg)] border border-border bg-card p-4">
			<span class="text-[0.7rem] [font-weight:var(--font-weight-label,500)] [letter-spacing:var(--tracking-label,0em)] uppercase tracking-wide text-foreground-muted">Invite collaborator</span>
			<Dialog.Root open={false}>
		...
		<!-- Change password -->
		<div class="flex flex-col gap-3 rounded-[var(--radius-lg)] border border-border bg-card p-4">
			<span class="text-[0.7rem] [font-weight:var(--font-weight-label,500)] [letter-spacing:var(--tracking-label,0em)] uppercase tracking-wide text-foreground-muted">Change password</span>
			<Dialog.Root open={false}>
		...
		<!-- Add payment -->
		<div class="flex flex-col gap-3 rounded-[var(--radius-lg)] border border-border bg-card p-4">
			<span class="text-[0.7rem] [font-weight:var(--font-weight-label,500)] [letter-spacing:var(--tracking-label,0em)] uppercase tracking-wide text-foreground-muted">Add payment method</span>
			<Dialog.Root open={false}>
		...
		<!-- Submit feedback -->
		<div class="flex flex-col gap-3 rounded-[var(--radius-lg)] border border-border bg-card p-4">
			<span class="text-[0.7rem] [font-weight:var(--font-weight-label,500)] [letter-spacing:var(--tracking-label,0em)] uppercase tracking-wide text-foreground-muted">Send feedback</span>
			<Dialog.Root open={false}>
				...
				<Dialog.Content class="w-full max-w-[28rem] gap-0 overflow-hidden p-0">
					...
					<div class="flex flex-col gap-3 px-5 py-4">
						<label class="flex flex-col gap-1">
							<span class="text-[0.78rem] [font-weight:var(--font-weight-label,500)] [letter-spacing:var(--tracking-label,0em)] text-foreground">Feedback</span>
							<textarea
								rows={4}
