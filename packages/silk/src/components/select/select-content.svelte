...
<Popover.Content
	...
	class={cn(
		props.class,
		'w-[var(--popover-trigger-width)] bg-[var(--color-panel)] text-[var(--color-panel-foreground)] border border-border rounded-[var(--radius-lg)] shadow-[var(--panel-shadow)] p-[var(--menu-padding)] flex flex-col gap-0'
	)}
>
