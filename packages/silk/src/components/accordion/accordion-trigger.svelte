...
<button
	...
	class={cn(
		'flex w-full items-center justify-between gap-3 py-4 text-left [font-size:calc(var(--font-size-button,14px)*1.086)] [font-weight:var(--font-weight-button,500)] [letter-spacing:var(--tracking-button,0em)] text-foreground transition-colors hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-ring)] disabled:cursor-not-allowed disabled:opacity-50',
		className
	)}
	{...rest}
>
